...
/// 
/// NOTE: Labels in Merlin must be static for domain separation to work correctly.
/// It is not intended to have dynamic labels, only values/messages can be dynamic.
